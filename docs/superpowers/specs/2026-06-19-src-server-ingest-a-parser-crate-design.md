...
| integ: 真实文件 | 一个真实 .md / .pdf / .docx / .xlsx → 非空 text | **需真实样本文件**——放 `crates/llm-wiki-parser/tests/fixtures/` |
...
| `crates/llm-wiki-parser/Cargo.toml` | **Create** — deps: pdfium-render, docx-rs, calamine, zip, image, sha2, base64 |
